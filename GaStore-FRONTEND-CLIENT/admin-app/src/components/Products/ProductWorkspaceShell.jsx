...
export const ProductSurface = ({ className = "", children, ...props }) => (
  <section
    {...props}
    className={`rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] sm:p-6 ${className}`.trim()}
  >
    {children}
  </section>
);
