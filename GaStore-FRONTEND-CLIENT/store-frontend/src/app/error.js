  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-pink-100 p-4 sm:p-6">
      <div className="max-w-md w-full bg-white shadow-2xl rounded-2xl p-8 text-center border-t-4 border-red-500 transform hover:scale-105 transition-transform duration-300 ease-in-out">
        <div className="mb-6">
          <h1 className="text-7xl font-extrabold text-red-500 drop-shadow-lg animate-pulse-slow">
            Oops!
          </h1>
          ...
          <p className="text-gray-600 mt-3 leading-relaxed">
            We're really sorry, but an unexpected issue occurred.
            <br /> Please try again, or navigate home if the problem persists.
          </p>
        </div>
        ...
        <div className="space-y-4 mt-6">
          ...
          <a
            href="/" // Using <a> tag directly as this might be the only way out of a pervasive error
