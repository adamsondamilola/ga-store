...
export const defaultWebsiteContent = {
  siteName: "GaStore",
  siteDescription:
    "Shop different types of products at GaStore, your online store for everyday essentials, lifestyle items, and more in Nigeria.",
  footerDescription:
    "GaStore brings together different types of products in one reliable online store, making it easy to shop for everyday needs, lifestyle items, and more.",
  logoUrl: "",
  ...
  faqItems: [
    {
      question: "What products can I buy on GaStore?",
      answer:
        "GaStore offers different types of products, including everyday essentials, lifestyle items, and other products available on our storefront.",
    },
    {
      question: "How can I place an order on GaStore?",
      answer:
