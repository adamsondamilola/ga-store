...
namespace GaStore.Data.Dtos.ProductsDto
{
	public class ProductSpecificationDto
	{
		...
		public virtual ProductDto? ProductDto { get; set; } // Navigation property to the product
		[MaxLength(255)]
        ...
        public string? Nafdac { get; set; }
        public string? Fda { get; set; } // FDA code
		public bool? FdaApproved { get; set; } // FDA approval status (true or false)
		public string? Disclaimer { get; set; } // Legal disclaimer or important information
