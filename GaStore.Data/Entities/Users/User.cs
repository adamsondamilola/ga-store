...
namespace GaStore.Data.Entities.Users
{
    public class User : EntityBase
    {
        ...
        public virtual VendorKyc? VendorKyc { get; set; }
        public virtual ICollection<Product> VendorProducts { get; set; } = new List<Product>();
        public virtual ICollection<VendorKyc> ReviewedVendorKycs { get; set; } = new List<VendorKyc>();
        public virtual ICollection<Product> ModeratedProducts { get; set; } = new List<Product>();
